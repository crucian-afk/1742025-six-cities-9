...
export default function Property({offers}: propertyProps): JSX.Element {
        ...
        <div className="property__container container">
          <div className="property__wrapper">
            ...
            <div className="property__name-wrapper">
              ...
              <button className={`property__bookmark-button ${isFavorite && 'property__bookmark-button--active'}`} type="button">
